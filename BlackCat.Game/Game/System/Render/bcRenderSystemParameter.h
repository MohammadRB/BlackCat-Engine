...
namespace black_cat
{
	namespace game
	{
		...
		constexpr bcSIZE g_render_pass_state_constant_buffer_min_index = 0 + 1; // +1 for global cbuffer
		...
		<
			graphic::bc_render_target_view_ptr,
		...
		using bc_render_pass_state_sampler_array = core::bc_array
			...
			>;
		using bc_render_pass_state_shader_view_array = core::bc_array
		<
			graphic::bc_shader_view_parameter,
		...
		>;
		using bc_render_state_shader_view_array = core::bc_array
		<
			graphic::bc_shader_view_parameter,
