...
namespace black_cat
{
	namespace editor
	{
		...
		bc_iui_commnad::state_ptr bc_ui_terrain_material_smooth_command::create_state(state_context& p_context) const
		{
			...
			auto l_device_compute_state = l_render_system.create_device_compute_state("terrain_material_smooth_cs");
		...
		bool bc_ui_terrain_material_smooth_command::update(update_context& p_context)
		{
		...
		void bc_ui_terrain_material_smooth_command_render_task::execute(game::bc_render_system& p_render_system, game::bc_render_thread& p_render_thread)
		{
			...
			(
				...
				{},
				{
					graphic::bc_resource_view_parameter(0, graphic::bc_shader_type::compute, l_temp_texture_view)
				},
				{
