...
namespace black_cat
{
	namespace platform
	{
		...
		template<>
		BC_PLATFORMIMP_DLL
		void bc_platform_socket<core_platform::g_api_win32>::get_traits(bc_socket_address& p_address, bc_socket_type& p_type, bc_socket_protocol& p_protocol) const
		{
		...
		template<>
		BC_PLATFORMIMP_DLL
		void bc_platform_socket<core_platform::g_api_win32>::connect(bc_socket_address p_address_family, const bcCHAR* p_ip, bcUINT16 p_port)
		{
