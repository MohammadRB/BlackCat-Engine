...
namespace black_cat
{
	namespace editor
	{
		...
		struct bc_ui_terrain_material_smooth_command_parameter_cbuffer
		{
			BC_CBUFFER_ALIGN
		...
		using bc_ui_terrain_material_smooth_command_state = bc_ui_terrain_command_state;
		...
		public:
			...
			bc_ui_terrain_material_smooth_command(const bc_ui_terrain_material_smooth_command&);

			~bc_ui_terrain_material_smooth_command();

			bc_ui_terrain_material_smooth_command& operator=(const bc_ui_terrain_material_smooth_command&);
		...
		class bc_ui_terrain_material_smooth_command_render_task : public game::bci_render_task
		{
		public:
			bc_ui_terrain_material_smooth_command_render_task(const bc_editor_height_map_dx11& p_height_map,
			...
			bc_ui_terrain_material_smooth_command_state& m_command_state;
			bc_ui_terrain_material_smooth_command_parameter_cbuffer m_shader_parameter;
		};
	}
}