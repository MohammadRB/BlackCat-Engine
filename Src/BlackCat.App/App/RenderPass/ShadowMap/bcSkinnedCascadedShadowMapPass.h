...
namespace black_cat
{
	...
	public:
		explicit bc_skinned_cascaded_shadow_map_pass(const bc_base_cascaded_shadow_map_pass& p_other_instance);

		bc_skinned_cascaded_shadow_map_pass(game::bc_render_pass_variable_t p_output_depth_buffers,
	...
	private:
		...
		core::bc_deque<game::bc_scene_render_state_query> m_scene_queries;
