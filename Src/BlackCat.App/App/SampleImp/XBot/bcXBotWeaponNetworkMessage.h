...
namespace black_cat
{
	...
	class BC_DLL bc_xbot_weapon_drop_network_message : public game::bci_network_message
	{
		BC_NETWORK_MESSAGE(xbw_drp)

	public:
		bc_xbot_weapon_drop_network_message() noexcept;

		explicit bc_xbot_weapon_drop_network_message(const game::bc_actor& p_actor) noexcept;

		bc_xbot_weapon_drop_network_message(bc_xbot_weapon_drop_network_message&&) noexcept;

		~bc_xbot_weapon_drop_network_message() override;

		bc_xbot_weapon_drop_network_message& operator=(bc_xbot_weapon_drop_network_message&&) noexcept;
