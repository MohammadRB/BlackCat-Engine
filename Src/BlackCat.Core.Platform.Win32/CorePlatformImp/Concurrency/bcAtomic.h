...
namespace black_cat
{
	namespace platform
	{
		...
		template<>
		inline bc_platform_atomic_flag<bc_platform::win32>::bc_platform_atomic_flag() noexcept = default;
		...
		{
			static_assert(!std::is_same_v<T, bool>, "atomic fetch_add is not supported with bool");
		...
		{
			static_assert(!std::is_same_v<T, bool>, "atomic fetch_sub is not supported with bool");
		...
		{
			static_assert(!std::is_same_v<T, bool>, "atomic fetch_and is not supported with bool");
			static_assert(std::is_integral_v<T>, "atomic fetch_and is not supported with non integral types");
		...
		{
			static_assert(!std::is_same_v<T, bool>, "atomic fetch_or is not supported with bool");
			static_assert(std::is_integral_v<T>, "atomic fetch_or is not supported with non integral types");
