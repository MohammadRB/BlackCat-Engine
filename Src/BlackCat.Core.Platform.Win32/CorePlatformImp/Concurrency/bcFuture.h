...
namespace black_cat
{
	namespace core_platform
	{
		...
		template< bc_platform TPlatform, typename T >
		bc_future_status bc_platform_future<TPlatform, T>::wait_for(const bcUINT64 p_nano) const
		{
		...
		template< bc_platform TPlatform, typename T >
		bc_future_status bc_platform_shared_future<TPlatform, T>::wait_for(const bcUINT64 p_nano) const
		{
