...
namespace black_cat::core
{
	...
	public:
		...
		bc_vector4(const bc_vector4& p_vector) noexcept = default;

		~bc_vector4() = default;

		bc_vector4& operator=(const bc_vector4& p_other) noexcept = default;
	...
	using bc_color4 = bc_vector4<bcUBYTE>;
