...
namespace black_cat
{
	namespace game
	{
		bc_network_server_manager_client::bc_network_server_manager_client(bc_network_server_manager& p_manager, platform::bc_non_block_socket p_socket)
			: bc_server_client_socket_state_machine(*BC_NEW(platform::bc_non_block_socket, core::bc_alloc_type::unknown)(std::move(p_socket))),
			m_manager(&p_manager),
