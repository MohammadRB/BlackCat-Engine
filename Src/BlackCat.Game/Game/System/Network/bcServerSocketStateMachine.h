...
namespace black_cat
{
	namespace game
	{
		...
		class bc_server_socket_error_state : core::bc_state<bc_server_socket_state_machine, bc_server_socket_bind_event>
		{
		public:
		...
		class bc_server_socket_accepting_state : core::bc_state<bc_server_socket_state_machine, bc_server_socket_update_event>
		{
		public:
		...
		class bc_server_socket_listening_state : core::bc_state<bc_server_socket_state_machine, bc_server_socket_update_event>
		{
		public:
		...
		private:
			state_transition handle(bc_server_socket_update_event& p_event) override
			{
				if(m_socket->is_accept_available())
				{
					...
					(
						[l_socket = std::move(l_client_socket)](bc_server_socket_accepting_state& p_state) mutable
						{
