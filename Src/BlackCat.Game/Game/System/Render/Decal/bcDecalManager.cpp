	...
	void bc_decal_manager::read_decal_file(const bcECHAR* p_decal_file)
	{
		...
		for (core::bc_json_object<_bc_decal_desc>& l_decal : l_decal_json->m_decals)
		{
			...
			_bc_decal_desc_entry l_desc
			{
				...
				l_decal->m_u0.has_value() ? core::bc_optional(*l_decal->m_u0) : nullptr,
				l_decal->m_v0.has_value() ? core::bc_optional(*l_decal->m_v0) : nullptr,
				l_decal->m_u1.has_value() ? core::bc_optional(*l_decal->m_u1) : nullptr,
				l_decal->m_v1.has_value() ? core::bc_optional(*l_decal->m_v1) : nullptr,
				*l_decal->m_width,
				*l_decal->m_height,
				*l_decal->m_depth,
