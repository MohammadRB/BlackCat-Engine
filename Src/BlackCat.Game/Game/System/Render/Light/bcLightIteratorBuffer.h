...
namespace black_cat
{
	namespace game
	{
		...
		public:
			bc_light_iterator_buffer(platform::bc_shared_mutex& p_container_lock, const container_type& p_container);
		...
		private:
			platform::bc_shared_mutex* m_container_lock;
			const container_type* m_container;
		};

		template<class TContainer>
		bc_light_iterator_buffer<TContainer>::bc_light_iterator_buffer(platform::bc_shared_mutex& p_container_lock, const container_type& p_container)
