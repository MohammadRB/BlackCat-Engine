...
namespace black_cat::constant
{
	...
	BC_PARAMETER(sound_auto_play, "auto_play");
	...
	BC_PARAMETER(particle_emitter_name, "emitter_name");
	BC_PARAMETER(particle_color, "color");
	...
	BC_PARAMETER(fog_center, "fog_center");
