...
namespace black_cat
{
	namespace game
	{
		bc_model_to_skinned_transform_animation_job::bc_model_to_skinned_transform_animation_job(bc_local_to_model_transform_animation_job& p_model_job, bc_sub_mesh_mat4_transform& p_transforms)
