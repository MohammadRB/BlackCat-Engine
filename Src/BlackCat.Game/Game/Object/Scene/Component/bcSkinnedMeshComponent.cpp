...
namespace black_cat
{
	namespace game
	{
		...
		void bc_skinned_mesh_component::render(const bc_actor_component_render_context& p_context) const
		{
			...
			bc_mesh_utility::render_skinned_mesh(p_context.m_buffer, l_render_states, l_world_transforms, l_lod.first, bc_actor_render_group::dynamic_mesh);
		}
			...
			bc_mesh_node::node_index_t p_attached_node_index)
		{
			...
			(
				...
				l_local_position,
				l_local_rotation,
				bc_actor_render_group::dynamic_mesh,
				l_world_transform,
