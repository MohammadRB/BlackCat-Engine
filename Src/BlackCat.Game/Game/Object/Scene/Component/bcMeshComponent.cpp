...
namespace black_cat
{
	namespace game
	{
		...
		{
			const auto& l_mesh_name = p_parameters.get_value_throw< core::bc_string >(constant::g_param_mesh);
			const auto* l_sub_mesh_name = p_parameters.get_value< core::bc_string >(constant::g_param_sub_mesh);
