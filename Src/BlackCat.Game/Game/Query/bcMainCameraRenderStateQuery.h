...
namespace black_cat
{
	namespace game
	{
		...
		public:
			bc_main_camera_render_state_query(const bc_camera_instance& p_camera, bc_render_state_buffer p_buffer);
		...
		inline bc_main_camera_render_state_query::bc_main_camera_render_state_query(const bc_camera_instance& p_camera, bc_render_state_buffer p_buffer)
