...
namespace black_cat
{
	...
	public:
		...
		bc_xbot_grenade_throw_network_message(const bcCHAR* p_grenade_name, const core::bc_vector3f& p_position, const core::bc_vector3f& p_direction) noexcept;
	...
	private:
		...
		game::bc_actor _create_actor() const;
