...
namespace black_cat
{
	...
	{
		template<>
		struct bc_thread_local_pack<bc_platform::win32>
		{
			DWORD m_tls_index;
		};

		template< bc_platform TPlatform, typename T >
		void bc_thread_local_proxy<TPlatform, T>::_platform_initialize()
		{
		...
		template< bc_platform TPlatform, typename T >
		void bc_thread_local_proxy<TPlatform, T>::_platform_cleanup()
		{
		...
		template< bc_platform TPlatform, typename T >
		void bc_thread_local_proxy<TPlatform, T>::_platform_assign(this_type&& p_other)
		{
			m_pack.m_tls_index = p_other.m_pack.m_tls_index;
		};

		template< bc_platform TPlatform, typename T >
		bool bc_thread_local_proxy<TPlatform, T>::_platform_set(type* p_pointer)
		{
		...
		template< bc_platform TPlatform, typename T >
		typename bc_thread_local_proxy<TPlatform, T>::type* bc_thread_local_proxy<TPlatform, T>::_platform_get() const
		{
