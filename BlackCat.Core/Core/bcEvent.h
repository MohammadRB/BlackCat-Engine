...
namespace black_cat
{
	namespace core
	{
		...
		public:
			...
			bc_app_event_warning(bc_app_event_warning&& p_other) noexcept(std::is_nothrow_move_constructible_v< bc_string >)
				: bc_app_event(p_other),
				m_message(std::move(p_other.m_message))
			{
			}
			...
			bc_app_event_warning& operator =(bc_app_event_warning&& p_other) noexcept(std::is_nothrow_move_assignable_v< bc_string >)
			{
				m_message = std::move(p_other.m_message);
