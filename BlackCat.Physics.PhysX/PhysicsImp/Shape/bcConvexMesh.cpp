...
namespace black_cat
{
	namespace physics
	{
		...
		{
			physx::PxConvexMesh* l_px_convex_mesh = static_cast< physx::PxConvexMesh* >
			(
		...
		{
			bc_platform_bound_box< g_api_physx > l_bound;
			physx::PxConvexMesh* l_px_convex_mesh = static_cast< physx::PxConvexMesh* >
			(
				static_cast< bc_platform_physics_reference& >(const_cast< bc_platform_convex_mesh& >(*this)).get_platform_pack().m_px_object
			);
			l_bound.get_platform_pack().m_bound = l_px_convex_mesh->getLocalBounds();
		...
		{
			return static_cast<bc_platform_physics_reference&>(const_cast<bc_platform_convex_mesh&>(*this)).get_platform_pack().m_px_object != nullptr;
		}
	}
}