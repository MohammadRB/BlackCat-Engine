...
namespace black_cat
{
	namespace physics
	{
		...
		template<>
		BC_PHYSICSIMP_DLL
		bc_platform_scene< g_api_physx >::bc_platform_scene(bc_platform_scene&& p_other) noexcept
		{
		...
		template<>
		BC_PHYSICSIMP_DLL
		bc_platform_scene< g_api_physx >& bc_platform_scene< g_api_physx >::operator=(bc_platform_scene&& p_other) noexcept
		{
			...
			p_other.m_pack.m_px_scene = nullptr;
			p_other.m_pack.m_allocator = nullptr;
		...
		void bc_platform_scene< g_api_physx >::add_actor(bc_actor& p_actor)
		{
			...
			m_pack.m_px_scene->addActor(*l_px_actor);
		}
		...
		{
			return m_pack.m_px_scene->getNbActors(static_cast< physx::PxActorTypeFlag::Enum >(p_types));
		}
		...
		{
			bcUINT32 l_written_count = m_pack.m_px_scene->getActors
			(
		...
		void bc_platform_scene< g_api_physx >::add_aggregate(bc_aggregate& p_aggregate)
		{
			...
			m_pack.m_px_scene->addAggregate(*l_px_aggregate);
		}
		...
		{
			return m_pack.m_px_scene->getNbAggregates();
		}
		...
		{
			bcUINT32 l_written_count = m_pack.m_px_scene->getAggregates
			(
		...
		{
			return m_pack.m_px_scene->getNbConstraints();
		}
		...
		{
			bcUINT32 l_written_count = m_pack.m_px_scene->getConstraints
			(
		...
		{
			return m_pack.m_px_scene->checkResults();
		}
		...
		{
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eSCALE, 1.0f);
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eCOLLISION_AABBS, true);
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eCOLLISION_SHAPES, true);
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eCOLLISION_COMPOUNDS, true);
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eJOINT_LOCAL_FRAMES, true);
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eJOINT_LIMITS, true);
		}
		...
		{
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eSCALE, 0.0f);
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eCOLLISION_AABBS, false);
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eCOLLISION_SHAPES, false);
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eCOLLISION_COMPOUNDS, false);
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eJOINT_LOCAL_FRAMES, false);
			m_pack.m_px_scene->setVisualizationParameter(physx::PxVisualizationParameter::eJOINT_LIMITS, false);
		}
			...
			bc_query_group p_query_groups) const
		{
			...
			return m_pack.m_px_scene->raycast
			(
				l_origin,
				l_dir,
				p_ray.m_length,
				...
				l_px_filter_data,
				&const_cast<bc_platform_scene&>(*this).m_pack.m_query_filter_callback
			);
		}
			...
			bc_query_group p_query_groups) const
		{
			...
			return m_pack.m_px_scene->sweep
			(
			...
			bc_query_group p_query_groups) const
		{
			...
			return m_pack.m_px_scene->overlap
			(
				const_cast<bc_shape_geometry&>(p_geometry).get_platform_pack().m_px_geometry,
				const_cast< bc_transform& >(p_pose).get_platform_pack().m_px_transform,
				p_buffer.get_platform_pack().m_px_query,
