...
namespace black_cat
{
	...
	{
		template< >
		inline const bcCHAR* bc_device_resource_content<bc_geometry_shader>::content_name()
		{
			return core::g_cnt_geometry_shader;
		}

		/*struct bc_geometry_shader_loader_parameter
		{
			bc_geometry_shader_loader_parameter(bc_device& p_device, const bcCHAR* p_function)
				: m_device(p_device),
		...
		class BC_GRAPHICSHARED_DLL bc_geometry_shader_loader : public core::bc_base_content_loader
		{
		public:
