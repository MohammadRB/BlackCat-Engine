...
namespace black_cat
{
	namespace graphic
	{
		...
		template< bc_platform_render_api TRenderApi >
		class bc_platform_hull_shader : public bc_ishader
		{
		public:
		...
		public:
			...
			bc_platform_hull_shader(bc_platform_hull_shader&& p_other);

			~bc_platform_hull_shader();

			bc_platform_hull_shader& operator=(bc_platform_hull_shader&& p_other);
		...
		using bc_hull_shader_ptr = bc_resource_ptr< bc_hull_shader >;
