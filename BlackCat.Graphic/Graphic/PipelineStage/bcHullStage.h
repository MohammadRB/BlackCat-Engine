...
namespace black_cat
{
	namespace graphic
	{
		...
		{
		public:
			bc_platform_hull_stage();

			bc_platform_hull_stage(bc_platform_hull_stage&&);

			~bc_platform_hull_stage();

			bc_platform_hull_stage& operator=(bc_platform_hull_stage&&);
		...
		using bc_hull_stage = bc_platform_hull_stage< g_current_platform_render_api >;
	}
}