...
public:
    ...
    QLabel *entityNameLable;
    QLabel *entityNameLableValue;
    ...
    void setupUi(QMainWindow *bcBlackCatEditorClass)
    {
        ...
        entityNameLable = new QLabel(rightToolBoxObjectSelect);
        entityNameLable->setObjectName(QStringLiteral("entityNameLable"));
        entityNameLable->setGeometry(QRect(10, 10, 81, 16));
        entityNameLableValue = new QLabel(rightToolBoxObjectSelect);
        entityNameLableValue->setObjectName(QStringLiteral("entityNameLableValue"));
        entityNameLableValue->setGeometry(QRect(100, 10, 231, 16));
    ...
    void retranslateUi(QMainWindow *bcBlackCatEditorClass)
    {
        ...
        entityNameLable->setText(QApplication::translate("bcBlackCatEditorClass", "ObjectName:", nullptr));
        entityNameLableValue->setText(QString());
