...
public:
    ...
    void setupUi(QMainWindow *bcBlackCatEditorClass)
    {
        ...
        decalRotationZText->setObjectName(QStringLiteral("decalRotationZText"));
        ...
        decalRotationZLabel->setObjectName(QStringLiteral("decalRotationZLabel"));
        decalRotationZLabel->setGeometry(QRect(10, 120, 16, 16));
        decalRotationXText = new QLineEdit(rightToolBoxDecalSelect);
        decalRotationXText->setObjectName(QStringLiteral("decalRotationXText"));
        ...
        decalRotationYText->setObjectName(QStringLiteral("decalRotationYText"));
        ...
        decalRotationXLabel->setObjectName(QStringLiteral("decalRotationXLabel"));
        decalRotationXLabel->setGeometry(QRect(10, 60, 16, 16));
        decalRotationYLabel = new QLabel(rightToolBoxDecalSelect);
        decalRotationYLabel->setObjectName(QStringLiteral("decalRotationYLabel"));
        decalRotationYLabel->setGeometry(QRect(10, 90, 16, 16));
        decalNameLabelValue_2 = new QLabel(rightToolBoxDecalSelect);
        decalNameLabelValue_2->setObjectName(QStringLiteral("decalNameLabelValue_2"));
    ...
    void retranslateUi(QMainWindow *bcBlackCatEditorClass)
    {
        ...
        decalRotationZLabel->setText(QApplication::translate("bcBlackCatEditorClass", "z:", nullptr));
        decalRotationLabel->setText(QApplication::translate("bcBlackCatEditorClass", "D\331\220ecal Rotation:", nullptr));
        decalRotationXLabel->setText(QApplication::translate("bcBlackCatEditorClass", "x:", nullptr));
        decalRotationYLabel->setText(QApplication::translate("bcBlackCatEditorClass", "y:", nullptr));
