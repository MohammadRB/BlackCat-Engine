...
namespace black_cat
{
	...
	{
		template<>
		struct bc_render_application_parameter_pack< core_platform::bc_platform::win32 >
			: public bc_render_application_parameter_pack< core_platform::bc_platform::unknown >
		{
		private:
			using base_type = bc_render_application_parameter_pack< core_platform::bc_platform::unknown >;

		public:
			bc_render_application_parameter_pack(HINSTANCE p_instance,
				const bcECHAR* p_app_name,
				bcUINT32 p_window_width,
				bcUINT32 p_window_height,
				const bcCHAR* p_commandline)
				: base_type(p_app_name, p_window_width, p_window_height, p_commandline),
		...
		template<>
		struct bc_render_application_pack< core_platform::bc_platform::win32 > 
			: public bc_render_application_pack< core_platform::bc_platform::unknown >
		{
			explicit bc_render_application_pack(HINSTANCE p_instance)
				: m_instance(p_instance)
			{
			}
